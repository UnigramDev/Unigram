...
namespace Unigram.Views
{
    public class TLLocator
    {
        ...
        public T Resolve<T>()
        {
            ...
            else if (type == typeof(Unigram.ViewModels.ChatListViewModel))
            {
                return (T)(object)new Unigram.ViewModels.ChatListViewModel(
                    _protoService,
                    _cacheService,
                    _settingsService,
                    _eventAggregator,
                    _notificationsService,
                    Resolve<Telegram.Td.Api.ChatList>()); 
            }
            ...
            else if (type == typeof(Unigram.ViewModels.Settings.SettingsVoIPViewModel))
            {
                return (T)(object)new Unigram.ViewModels.Settings.SettingsVoIPViewModel(
                    _protoService,
                    _cacheService,
                    _settingsService,
                    _eventAggregator,
