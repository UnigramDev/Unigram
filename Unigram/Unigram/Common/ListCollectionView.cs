...
namespace Unigram.Common
{
    ...
    public class ObservableVector<T> : ObservableCollection<T>, IObservableVector<T>
    {
        ...
        //    VectorChanged?.Invoke(this, new ListCollectionView.VectorChangedEventArgs(ActionToChange(e.Action), index, item));
        //}
        ...
        private CollectionChange ActionToChange(NotifyCollectionChangedAction action)
        {
            switch (action)
            {
                case NotifyCollectionChangedAction.Add:
