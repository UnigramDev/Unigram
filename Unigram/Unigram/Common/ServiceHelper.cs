...
//            _actionsCache.Add(typeof(TLMessageActionChatCreate), (TLMessageActionBase action, int fromUserId, string fromUserFullName) => ReplaceLinks(Resources.MessageActionChatCreate, new[] { fromUserFullName, ((TLMessageActionChatCreate)action).Title.Value }, new[] { fromUserId }));
...
//            _actionsCache.Add(typeof(TLMessageActionChatEditTitle), (TLMessageActionBase action, int fromUserId, string fromUserFullName) => ReplaceLinks(Resources.MessageActionChatEditTitle, new[] { fromUserFullName, ((TLMessageActionChatEditTitle)action).Title.Value }, new[] { fromUserId }));
...
//                var user = ServiceLocator.Current.GetInstance<ICacheService>().GetUser(userId);
...
//                var user = ServiceLocator.Current.GetInstance<ICacheService>().GetUser(inviterId);
//                var username = (user != null) ? user.FullName : Resources.User;
...
//            var user = ServiceLocator.Current.GetInstance<ICacheService>().GetUser(fromId);
//            var username = (user != null) ? user.FullName : Resources.User;
...
//                {
//                    navigationService.Navigate(typeof(UserInfoPage), user);
//                }
//            }
//        }
//    }
