...
namespace Unigram.ViewModels.Settings.Privacy
{
    public abstract class SettingsPrivacyAlwaysViewModelBase : UsersSelectionViewModel, INavigableWithResult<UserPrivacySettingRuleAllowUsers>
    {
        ...
        public SettingsPrivacyAlwaysViewModelBase(IProtoService protoService, ICacheService cacheService, ISettingsService settingsService, IEventAggregator aggregator, UserPrivacySetting inputKey)
