...
namespace Unigram.ViewModels.Settings
{
    public class SettingsNotificationsViewModel : UnigramViewModelBase, IHandle<TLUpdateNotifySettings>, IHandle
    {
        ...
        {
            var confirm = await TLMessageDialog.ShowAsync(Strings.DialogResources.ResetNotificationsDialogBody, Strings.DialogResources.ResetNotificationsDialogTitle, Strings.DialogResources.OK, Strings.DialogResources.Cancel);
