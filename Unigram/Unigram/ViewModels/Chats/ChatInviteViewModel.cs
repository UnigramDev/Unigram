        ...
        protected override async void SendExecute()
        {
            ...
            else
            {
                if (response.Error.TypeEquals(TLErrorType.PEER_FLOOD))
                {
                    ...
                    dialog.Message = Strings.ErrorMessages.PeerFloodAddContact;
                ...
                {
                    await TLMessageDialog.ShowAsync(Strings.ErrorMessages.UsersTooMuch, "Telegram", "OK");
                }
                else if (response.Error.TypeEquals(TLErrorType.BOTS_TOO_MUCH))
                {
                    await TLMessageDialog.ShowAsync(Strings.ErrorMessages.BotsTooMuch, "Telegram", "OK");
                }
                else if (response.Error.TypeEquals(TLErrorType.USER_NOT_MUTUAL_CONTACT))
                {
                    await TLMessageDialog.ShowAsync(Strings.ErrorMessages.UserNotMutualContact, "Telegram", "OK");
                }
