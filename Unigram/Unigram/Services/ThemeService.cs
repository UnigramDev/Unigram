...
namespace Unigram.Services
{
    ...
    public class ThemeService : IThemeService
    {
        ...
        public Color GetDefaultColor(TelegramTheme flags, string key)
        {
            ...
            {
                resources = flags.HasFlag(TelegramTheme.Light) ? _defaultLightBrand : _defaultDarkBrand;
            }
            else
            {
                resources = flags.HasFlag(TelegramTheme.Light) ? _defaultLight : _defaultDark;
            }
        ...
        private readonly Dictionary<string, object> _defaultDarkBrand = new Dictionary<string, object>
        {
        ...
        private readonly Dictionary<string, object> _defaultLightBrand = new Dictionary<string, object>
        {
        ...
        {
            { "ApplicationPageBackgroundThemeBrush", Color.FromArgb(0xFF, 0x00, 0x00, 0x00) },
            { "PageHeaderForegroundBrush", "SystemBaseHighColor" },
            { "PageHeaderHighlightBrush", "SystemAccentColor" },
            { "PageHeaderDisabledBrush", "SystemControlForegroundBaseMediumBrush" },
            { "PageHeaderBackgroundBrush", "SystemControlBackgroundChromeMediumLowBrush" },
            ...
            { "ChatUnreadBadgeBrush", "SystemAccentColor" },
            { "ChatUnreadLabelBrush", Color.FromArgb(0xFF, 0xFF, 0xFF, 0xFF) },
            { "MessageForegroundColor", Color.FromArgb(0xFF, 0xFF, 0xFF, 0xFF) },
            { "MessageForegroundOutColor", Color.FromArgb(0xFF, 0xFF, 0xFF, 0xFF) },
            { "MessageForegroundLinkColor", Color.FromArgb(0xFF, 0xFF, 0xFF, 0xFF) },
            { "MessageForegroundLinkOutColor", Color.FromArgb(0xFF, 0xFF, 0xFF, 0xFF) },
            { "MessageBackgroundColor", Color.FromArgb(0xFF, 0x1F, 0x2C, 0x36) },
            { "MessageBackgroundOutColor", "SystemAccentColorDark2" },
            { "MessageSubtleLabelColor", Color.FromArgb(0xFF, 0xA0, 0xAC, 0xB6) },
            { "MessageSubtleLabelOutColor", "SystemAccentColorLight2" },
            { "MessageSubtleGlyphColor", Color.FromArgb(0xFF, 0xA0, 0xAC, 0xB6) },
            { "MessageSubtleGlyphOutColor", "SystemAccentColorLight1" },
            { "MessageSubtleForegroundColor", "SystemChromeDisabledLowColor" },
            { "MessageSubtleForegroundOutColor", "SystemAccentColorLight2" },
            { "MessageHeaderForegroundColor", Color.FromArgb(0xFF, 0x0E, 0x7A, 0xCD) },
            { "MessageHeaderForegroundOutColor", "SystemAccentColorLight2" },
            { "MessageHeaderBorderColor", Color.FromArgb(0xFF, 0x2F, 0xA9, 0xE2) },
            { "MessageHeaderBorderOutColor", "SystemAccentColorLight2" },
            { "MessageMediaForegroundColor", Color.FromArgb(0xFF, 0xFF, 0xFF, 0xFF) },
            { "MessageMediaForegroundOutColor", "SystemAccentColorDark3" },
            { "MessageMediaBackgroundColor", Color.FromArgb(0xFF, 0x00, 0x7E, 0xE5) },
            { "MessageMediaBackgroundOutColor", "SystemAccentColor" },
            { "MessageOverlayBackgroundColor", Color.FromArgb(0x54, 0x00, 0x00, 0x00) },
            { "MessageOverlayBackgroundOutColor", Color.FromArgb(0x54, 0x00, 0x00, 0x00) },
            { "MessageCallForegroundColor", "Green" },
            { "MessageCallForegroundOutColor", "Green" },
            { "MessageCallMissedForegroundColor", "Red" },
            { "MessageCallMissedForegroundOutColor", "Red" },
            { "SystemAltHighColor", Color.FromArgb(0xFF, 0x00, 0x00, 0x00) },
            { "SystemAltLowColor", Color.FromArgb(0x33, 0x00, 0x00, 0x00) },
            { "SystemAltMediumColor", Color.FromArgb(0x99, 0x00, 0x00, 0x00) },
            { "SystemAltMediumHighColor", Color.FromArgb(0xCC, 0x00, 0x00, 0x00) },
        ...
        private readonly Dictionary<string, object> _defaultLight = new Dictionary<string, object>
        {
            ...
            { "MessageForegroundColor", Color.FromArgb(0xFF, 0x00, 0x00, 0x00) },
            { "MessageForegroundOutColor", Color.FromArgb(0xFF, 0x00, 0x00, 0x00) },
            { "MessageForegroundLinkColor", Color.FromArgb(0xFF, 0x00, 0x00, 0x00) },
            { "MessageForegroundLinkOutColor", Color.FromArgb(0xFF, 0x00, 0x00, 0x00) },
            { "MessageBackgroundColor", Color.FromArgb(0xFF, 0xFF, 0xFF, 0xFF) },
            { "MessageBackgroundOutColor", "SystemAccentColorLight3" },
            { "MessageSubtleLabelColor", Color.FromArgb(0xFF, 0xA0, 0xAC, 0xB6) },
            { "MessageSubtleLabelOutColor", "SystemAccentColorLight1" },
            { "MessageSubtleGlyphColor", Color.FromArgb(0xFF, 0xA0, 0xAC, 0xB6) },
            { "MessageSubtleGlyphOutColor", "SystemAccentColorLight1" },
            { "MessageSubtleForegroundColor", "SystemChromeDisabledLowColor" },
            { "MessageSubtleForegroundOutColor", "SystemAccentColorLight2" },
            { "MessageHeaderForegroundColor", Color.FromArgb(0xFF, 0x0E, 0x7A, 0xCD) },
            { "MessageHeaderForegroundOutColor", "SystemAccentColorDark1" },
            { "MessageHeaderBorderColor", Color.FromArgb(0xFF, 0x2F, 0xA9, 0xE2) },
            { "MessageHeaderBorderOutColor", "SystemAccentColorDark1" },
            { "MessageMediaForegroundColor", Color.FromArgb(0xFF, 0xFF, 0xFF, 0xFF) },
            { "MessageMediaForegroundOutColor", "SystemAccentColorDark1" },
            { "MessageMediaBackgroundColor", Color.FromArgb(0xFF, 0x00, 0x7E, 0xE5) },
            { "MessageMediaBackgroundOutColor", "SystemAccentColorLight2" },
            { "MessageOverlayBackgroundColor", Color.FromArgb(0x54, 0x00, 0x00, 0x00) },
            { "MessageOverlayBackgroundOutColor", Color.FromArgb(0x54, 0x00, 0x00, 0x00) },
            { "MessageCallForegroundColor", "Green" },
            { "MessageCallForegroundOutColor", "Green" },
