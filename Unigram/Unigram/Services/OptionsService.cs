...
namespace Unigram.Services
{
    public interface IOptionsService : IHandle<UpdateOption>
    {
        ...
        /// <summary>
        /// If true, notifications about the user's contacts who have joined Telegram will be disabled. User will still receive the corresponding message in the private chat. getOption needs to be called explicitly to fetch latest value of the option, changed from another device
        /// </summary>
