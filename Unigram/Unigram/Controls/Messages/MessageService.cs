                ...
                case MessageChatEvent chatEvent:
                    switch (chatEvent.Event.Action)
                    {
                        ...
                        case ChatEventMessageDeleted messageDeleted:
                            return chatEvent.IsFull ? GetEntities(new MessageViewModel(message.ProtoService, message.Aggregator, message.Delegate, messageDeleted.Message), active) : UpdateMessageDeleted(message, messageDeleted, active);
                        case ChatEventMessageEdited messageEdited:
                            return chatEvent.IsFull ? GetEntities(new MessageViewModel(message.ProtoService, message.Aggregator, message.Delegate, messageEdited.NewMessage), active) : UpdateMessageEdited(message, messageEdited, active);
                        ...
                        case ChatEventMessagePinned messagePinned:
                            return chatEvent.IsFull ? GetEntities(new MessageViewModel(message.ProtoService, message.Aggregator, message.Delegate, messagePinned.Message), active) : UpdateMessagePinned(message, messagePinned, active);
