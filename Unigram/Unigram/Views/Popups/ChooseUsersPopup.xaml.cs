...
{
    public sealed partial class ChooseUsersPopup : ContentPopup
    {
        public ShareViewModel ViewModel => DataContext as ShareViewModel;

        private ChooseUsersPopup()
        {
            InitializeComponent();
        ...
        public static async Task<User> PickUserAsync(ICacheService clientService, string title, bool contact)
        {
        ...
        public static async Task<IList<User>> PickUsersAsync(ICacheService clientService, string title)
        {
