...
//       
//       Command:
//           LottieGen -GenerateColorBindings -Language CSharp -MinimumUapVersion 8 -Namespace Unigram.Assets.Icons -Public -WinUIVersion 2.7 -InputFile StickerToGif.json
//       
//       Input file:
...
namespace Unigram.Assets.Icons
{
        ...
        , Microsoft.UI.Xaml.Controls.IAnimatedVisualSource2
    {
        ...
        public Microsoft.UI.Xaml.Controls.IAnimatedVisual TryCreateAnimatedVisual(Compositor compositor, out object diagnostics)
        {
            ...
            if (StickerToGif_AnimatedVisual_UAPv8.IsRuntimeCompatible())
            {
                var res = 
                    new StickerToGif_AnimatedVisual_UAPv8(
                        compositor,
                        _themeProperties
                        );
                    res.CreateAnimations();
        ...
        sealed class StickerToGif_AnimatedVisual_UAPv8 : Microsoft.UI.Xaml.Controls.IAnimatedVisual
        {
            const long c_durationTicks = 3333333;
            readonly Compositor _c;
            readonly ExpressionAnimation _reusableExpressionAnimation;
            ...
            CanvasGeometry Geometry_0()
            {
                ...
                using (var builder = new CanvasPathBuilder(null))
                {
                    builder.BeginFigure(new Vector2(-4.37900019F, -8.5F));
                    builder.AddCubicBezier(new Vector2(-6.65500021F, -8.5F), new Vector2(-8.5F, -6.65500021F), new Vector2(-8.5F, -4.37900019F));
                    builder.AddLine(new Vector2(-8.5F, 4.37900019F));
                    builder.AddCubicBezier(new Vector2(-8.5F, 6.65500021F), new Vector2(-6.65500021F, 8.5F), new Vector2(-4.37900019F, 8.5F));
                    builder.AddLine(new Vector2(1.5F, 8.5F));
                    builder.AddLine(new Vector2(8.5F, 1.5F));
                    builder.AddLine(new Vector2(8.5F, -4.37900019F));
                    builder.AddCubicBezier(new Vector2(8.5F, -6.65500021F), new Vector2(6.65500021F, -8.5F), new Vector2(4.37900019F, -8.5F));
                    builder.AddLine(new Vector2(-4.37900019F, -8.5F));
                    builder.EndFigure(CanvasFigureLoop.Closed);
                    result = CanvasGeometry.CreatePath(builder);
                }
                return result;
            ...
            CanvasGeometry Geometry_2()
            {
                ...
                using (var builder = new CanvasPathBuilder(null))
                {
                    builder.BeginFigure(new Vector2(-91.5449982F, -130.5F));
                    builder.AddCubicBezier(new Vector2(-114.440002F, -130.5F), new Vector2(-133F, -112.374001F), new Vector2(-133F, -90.0149994F));
                    builder.AddLine(new Vector2(-133F, -3.9849999F));
                    builder.AddCubicBezier(new Vector2(-133F, 18.3740005F), new Vector2(-114.440002F, 36.5F), new Vector2(-91.5449982F, 36.5F));
                    builder.AddLine(new Vector2(-32.4119987F, 36.5F));
                    builder.AddLine(new Vector2(38F, -32.2649994F));
                    builder.AddLine(new Vector2(38F, -90.0149994F));
                    builder.AddCubicBezier(new Vector2(38F, -112.374001F), new Vector2(19.4400005F, -130.5F), new Vector2(-3.45499992F, -130.5F));
                    builder.AddLine(new Vector2(-91.5449982F, -130.5F));
                    builder.EndFigure(CanvasFigureLoop.Closed);
                    result = CanvasGeometry.CreatePath(builder);
                }
                return result;
            ...
            internal StickerToGif_AnimatedVisual_UAPv8(
                Compositor compositor,
                CompositionPropertySet themeProperties
                )
            {
