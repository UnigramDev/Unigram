...
//       
//       Command:
//           LottieGen -GenerateColorBindings -Language CSharp -MinimumUapVersion 8 -Namespace Unigram.Assets.Icons -Public -WinUIVersion 2.7 -InputFile GifToSticker.json
//       
//       Input file:
...
namespace Unigram.Assets.Icons
{
        ...
        , Microsoft.UI.Xaml.Controls.IAnimatedVisualSource2
    {
        ...
        public Microsoft.UI.Xaml.Controls.IAnimatedVisual TryCreateAnimatedVisual(Compositor compositor, out object diagnostics)
        {
            ...
            if (GifToSticker_AnimatedVisual_UAPv8.IsRuntimeCompatible())
            {
                var res = 
                    new GifToSticker_AnimatedVisual_UAPv8(
                        compositor,
                        _themeProperties
                        );
                    res.CreateAnimations();
        ...
        sealed class GifToSticker_AnimatedVisual_UAPv8 : Microsoft.UI.Xaml.Controls.IAnimatedVisual
        {
            const long c_durationTicks = 3333333;
            readonly Compositor _c;
            readonly ExpressionAnimation _reusableExpressionAnimation;
            ...
            CanvasGeometry Geometry_0()
            {
                ...
                using (var builder = new CanvasPathBuilder(null))
                {
                    builder.BeginFigure(new Vector2(-5.37900019F, -8F));
                    builder.AddCubicBezier(new Vector2(-7.65500021F, -8F), new Vector2(-9.5F, -6.15500021F), new Vector2(-9.5F, -3.87899995F));
                    builder.AddLine(new Vector2(-9.5F, 3.87899995F));
                    builder.AddCubicBezier(new Vector2(-9.5F, 6.15500021F), new Vector2(-7.65500021F, 8F), new Vector2(-5.37900019F, 8F));
                    builder.AddLine(new Vector2(5.37900019F, 8F));
                    builder.AddCubicBezier(new Vector2(7.65500021F, 8F), new Vector2(9.5F, 6.15500021F), new Vector2(9.5F, 3.87899995F));
                    builder.AddLine(new Vector2(9.5F, -3.87899995F));
                    builder.AddCubicBezier(new Vector2(9.5F, -6.15500021F), new Vector2(7.65500021F, -8F), new Vector2(5.37900019F, -8F));
                    builder.AddLine(new Vector2(-5.37900019F, -8F));
            ...
            CanvasGeometry Geometry_2()
            {
                ...
                using (var builder = new CanvasPathBuilder(null))
                {
                    builder.BeginFigure(new Vector2(-100.396004F, -127.5F));
                    builder.AddCubicBezier(new Vector2(-123.097F, -127.5F), new Vector2(-141.5F, -109.107002F), new Vector2(-141.5F, -86.4169998F));
                    builder.AddLine(new Vector2(-141.5F, -9.08300018F));
                    builder.AddCubicBezier(new Vector2(-141.5F, 13.6070004F), new Vector2(-123.097F, 32F), new Vector2(-100.396004F, 32F));
                    builder.AddLine(new Vector2(6.89599991F, 32F));
                    builder.AddCubicBezier(new Vector2(29.5970001F, 32F), new Vector2(48F, 13.6070004F), new Vector2(48F, -9.08300018F));
                    builder.AddLine(new Vector2(48F, -86.4169998F));
                    builder.AddCubicBezier(new Vector2(48F, -109.107002F), new Vector2(29.5970001F, -127.5F), new Vector2(6.89599991F, -127.5F));
                    builder.AddLine(new Vector2(-100.396004F, -127.5F));
                    builder.EndFigure(CanvasFigureLoop.Closed);
                    result = CanvasGeometry.CreatePath(builder);
                }
                return result;
            ...
            internal GifToSticker_AnimatedVisual_UAPv8(
                Compositor compositor,
                CompositionPropertySet themeProperties
                )
            {
