...
namespace Unigram.Assets.Icons
{
        ...
        , Microsoft.UI.Xaml.Controls.IAnimatedVisualSource2
    {
        ...
        public Microsoft.UI.Xaml.Controls.IAnimatedVisual TryCreateAnimatedVisual(Compositor compositor, out object diagnostics)
        {
            ...
            if (MuteUnmute_AnimatedVisual_UAPv8.IsRuntimeCompatible())
            {
                var res = 
                    new MuteUnmute_AnimatedVisual_UAPv8(
                        compositor,
                        _themeProperties
                        );
                    res.CreateAnimations();
        ...
        sealed class MuteUnmute_AnimatedVisual_UAPv8 : Microsoft.UI.Xaml.Controls.IAnimatedVisual
        {
            const long c_durationTicks = 13333333;
            readonly Compositor _c;
            readonly ExpressionAnimation _reusableExpressionAnimation;
            ...
            CanvasGeometry Geometry_2()
            {
                ...
                {
                    builder.BeginFigure(new Vector2(-119.875F, -102.438004F));
                    builder.AddLine(new Vector2(-110.487999F, -102.438004F));
                    builder.AddLine(new Vector2(99.9540024F, 108.058998F));
                    builder.AddLine(new Vector2(110.553001F, 97.4580002F));
                    builder.AddLine(new Vector2(-89.2910004F, -102.438004F));
                    builder.AddLine(new Vector2(119.938004F, -102.438004F));
                    builder.AddLine(new Vector2(119.938004F, 137.438004F));
                    builder.AddLine(new Vector2(-119.875F, 137.438004F));
                    builder.AddLine(new Vector2(-119.875F, -102.438004F));
                    builder.EndFigure(CanvasFigureLoop.Closed);
                    result = CanvasGeometry.CreatePath(builder);
                }
                return result;
            ...
            CanvasGeometry Geometry_4()
            {
                ...
                {
                    builder.BeginFigure(new Vector2(-119.875F, -102.438004F));
                    builder.AddLine(new Vector2(-110.485001F, -102.438004F));
                    builder.AddLine(new Vector2(-89.8899994F, -81.8470001F));
                    builder.AddLine(new Vector2(-79.288002F, -92.4449997F));
                    builder.AddLine(new Vector2(-89.2829971F, -102.438004F));
                    builder.AddLine(new Vector2(120F, -102.438004F));
                    builder.AddLine(new Vector2(120F, 137.375F));
                    builder.AddLine(new Vector2(-119.875F, 137.375F));
                    builder.AddLine(new Vector2(-119.875F, -102.438004F));
                    builder.EndFigure(CanvasFigureLoop.Closed);
                    result = CanvasGeometry.CreatePath(builder);
                }
            ...
            ScalarKeyFrameAnimation TrimStartScalarAnimation_0_to_1()
            {
                ...
                result.InsertKeyFrame(0.537500024F, 0F, HoldThenStepEasingFunction());
                // Frame 57.
                result.InsertKeyFrame(0.712499976F, 1F, _c.CreateCubicBezierEasingFunction(new Vector2(0.166999996F, 0F), new Vector2(0.833000004F, 1F)));
                return result;
            }
            ...
            ScalarKeyFrameAnimation TrimStartScalarAnimation_1_to_0()
            {
                ...
                result.InsertKeyFrame(0.0375000015F, 1F, HoldThenStepEasingFunction());
                // Frame 16.
                result.InsertKeyFrame(0.200000003F, 0F, _c.CreateCubicBezierEasingFunction(new Vector2(0.600000024F, 0F), new Vector2(0.400000006F, 1F)));
                return result;
            }
            ...
            internal MuteUnmute_AnimatedVisual_UAPv8(
                Compositor compositor,
                CompositionPropertySet themeProperties
                )
            {
