...
namespace Telegram.Api.Services
{
	public partial class MTProtoService
	{
        ...
        public void GetAppChangelogCallback(string deviceModel, string systemVersion, string appVersion, string langCode, Action<TLUpdatesBase> callback, Action<TLRPCError> faultCallback = null)
        {
