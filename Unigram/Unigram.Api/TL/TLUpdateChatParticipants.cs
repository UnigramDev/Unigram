...
namespace Telegram.Api.TL
{
	public partial class TLUpdateChatParticipants : TLUpdateBase 
	{
		...
		public TLUpdateChatParticipants(TLBinaryReader from, TLType type = TLType.UpdateChatParticipants)
		{
			Read(from, type);
		}
		...
		public override void Read(TLBinaryReader from, TLType type = TLType.UpdateChatParticipants)
		{
