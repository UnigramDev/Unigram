...
namespace Telegram.Api.TL
{
	public partial class TLInputGeoPoint : TLInputGeoPointBase 
	{
		...
		public TLInputGeoPoint(TLBinaryReader from, TLType type = TLType.InputGeoPoint)
		{
			Read(from, type);
		}
		...
		public override void Read(TLBinaryReader from, TLType type = TLType.InputGeoPoint)
		{
			Lat = from.ReadDouble();
