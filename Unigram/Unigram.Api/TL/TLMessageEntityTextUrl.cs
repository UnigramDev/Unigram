...
namespace Telegram.Api.TL
{
	public partial class TLMessageEntityTextUrl : TLMessageEntityBase 
	{
		...
		public TLMessageEntityTextUrl(TLBinaryReader from, TLType type = TLType.MessageEntityTextUrl)
		{
			Read(from, type);
		}
		...
		public override void Read(TLBinaryReader from, TLType type = TLType.MessageEntityTextUrl)
		{
