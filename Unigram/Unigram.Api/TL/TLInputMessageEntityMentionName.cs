...
namespace Telegram.Api.TL
{
	public partial class TLInputMessageEntityMentionName : TLMessageEntityBase 
	{
		...
		public TLInputMessageEntityMentionName(TLBinaryReader from, TLType type = TLType.InputMessageEntityMentionName)
		{
			Read(from, type);
		}
		...
		public override void Read(TLBinaryReader from, TLType type = TLType.InputMessageEntityMentionName)
		{
