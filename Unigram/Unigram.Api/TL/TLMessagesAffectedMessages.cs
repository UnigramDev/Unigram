...
namespace Telegram.Api.TL
{
	public partial class TLMessagesAffectedMessages : TLObject, ITLMultiPts 
	{
		...
		public TLMessagesAffectedMessages(TLBinaryReader from, TLType type = TLType.MessagesAffectedMessages)
		{
			Read(from, type);
		}
		...
		public override void Read(TLBinaryReader from, TLType type = TLType.MessagesAffectedMessages)
		{
			Pts = from.ReadInt32();
