...
namespace Telegram.Api.TL
{
	public partial class TLChatParticipantsForbidden : TLChatParticipantsBase 
	{
		...
		public TLChatParticipantsForbidden(TLBinaryReader from, TLType type = TLType.ChatParticipantsForbidden)
		{
			Read(from, type);
		}
		...
		public override void Read(TLBinaryReader from, TLType type = TLType.ChatParticipantsForbidden)
		{
