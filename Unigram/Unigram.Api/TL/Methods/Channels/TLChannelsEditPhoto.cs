...
namespace Telegram.Api.TL.Methods.Channels
{
	...
	public partial class TLChannelsEditPhoto : TLObject
	{
		...
		public TLChannelsEditPhoto(TLBinaryReader from, TLType type = TLType.ChannelsEditPhoto)
		{
			Read(from, type);
		}
		...
		public override void Read(TLBinaryReader from, TLType type = TLType.ChannelsEditPhoto)
		{
