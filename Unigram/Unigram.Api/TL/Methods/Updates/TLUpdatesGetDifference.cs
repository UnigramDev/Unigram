...
namespace Telegram.Api.TL.Methods.Updates
{
	...
	public partial class TLUpdatesGetDifference : TLObject
	{
		...
		public TLUpdatesGetDifference(TLBinaryReader from, TLType type = TLType.UpdatesGetDifference)
		{
			Read(from, type);
		}
		...
		public override void Read(TLBinaryReader from, TLType type = TLType.UpdatesGetDifference)
		{
			Pts = from.ReadInt32();
			Date = from.ReadInt32();
			Qts = from.ReadInt32();
