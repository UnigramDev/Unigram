...
namespace Telegram.Api.TL.Methods.Auth
{
	...
	public partial class TLAuthCheckPhone : TLObject
	{
		...
		public TLAuthCheckPhone(TLBinaryReader from, TLType type = TLType.AuthCheckPhone)
		{
			Read(from, type);
		}
		...
		public override void Read(TLBinaryReader from, TLType type = TLType.AuthCheckPhone)
		{
