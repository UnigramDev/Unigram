...
namespace Telegram.Api.TL.Methods.Auth
{
	...
	public partial class TLAuthSendInvites : TLObject
	{
		...
		public TLAuthSendInvites(TLBinaryReader from, TLType type = TLType.AuthSendInvites)
		{
			Read(from, type);
		}
		...
		public override void Read(TLBinaryReader from, TLType type = TLType.AuthSendInvites)
		{
