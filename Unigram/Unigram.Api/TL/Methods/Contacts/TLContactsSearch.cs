...
namespace Telegram.Api.TL.Methods.Contacts
{
	...
	public partial class TLContactsSearch : TLObject
	{
		...
		public TLContactsSearch(TLBinaryReader from, TLType type = TLType.ContactsSearch)
		{
			Read(from, type);
		}
		...
		public override void Read(TLBinaryReader from, TLType type = TLType.ContactsSearch)
		{
			Q = from.ReadString();
