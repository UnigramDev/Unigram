...
namespace Telegram.Api.TL.Methods.Account
{
	...
	public partial class TLAccountConfirmPhone : TLObject
	{
		...
		public TLAccountConfirmPhone(TLBinaryReader from, TLType type = TLType.AccountConfirmPhone)
		{
			Read(from, type);
		}
		...
		public override void Read(TLBinaryReader from, TLType type = TLType.AccountConfirmPhone)
		{
