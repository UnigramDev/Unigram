...
namespace Telegram.Api.TL.Methods.Account
{
	...
	public partial class TLAccountChangePhone : TLObject
	{
		...
		public TLAccountChangePhone(TLBinaryReader from, TLType type = TLType.AccountChangePhone)
		{
			Read(from, type);
		}
		...
		public override void Read(TLBinaryReader from, TLType type = TLType.AccountChangePhone)
		{
