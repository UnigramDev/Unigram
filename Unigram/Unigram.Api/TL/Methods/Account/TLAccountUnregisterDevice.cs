...
namespace Telegram.Api.TL.Methods.Account
{
	...
	public partial class TLAccountUnregisterDevice : TLObject
	{
		...
		public TLAccountUnregisterDevice(TLBinaryReader from, TLType type = TLType.AccountUnregisterDevice)
		{
			Read(from, type);
		}
		...
		public override void Read(TLBinaryReader from, TLType type = TLType.AccountUnregisterDevice)
		{
