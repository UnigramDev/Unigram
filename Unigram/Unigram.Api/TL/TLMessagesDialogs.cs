...
namespace Telegram.Api.TL
{
	public partial class TLMessagesDialogs : TLMessagesDialogsBase 
	{
		...
		public TLMessagesDialogs(TLBinaryReader from, TLType type = TLType.MessagesDialogs)
		{
			Read(from, type);
		}
		...
		public override void Read(TLBinaryReader from, TLType type = TLType.MessagesDialogs)
		{
