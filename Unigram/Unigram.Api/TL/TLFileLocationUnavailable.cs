...
namespace Telegram.Api.TL
{
	public partial class TLFileLocationUnavailable : TLFileLocationBase 
	{
		...
		public TLFileLocationUnavailable(TLBinaryReader from, TLType type = TLType.FileLocationUnavailable)
		{
			Read(from, type);
		}
		...
		public override void Read(TLBinaryReader from, TLType type = TLType.FileLocationUnavailable)
		{
