...
namespace Telegram.Api.TL
{
	public partial class TLContactsBlocked : TLContactsBlockedBase 
	{
		...
		public TLContactsBlocked(TLBinaryReader from, TLType type = TLType.ContactsBlocked)
		{
			Read(from, type);
		}
		...
		public override void Read(TLBinaryReader from, TLType type = TLType.ContactsBlocked)
		{
