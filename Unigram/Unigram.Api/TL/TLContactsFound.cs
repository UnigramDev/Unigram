...
namespace Telegram.Api.TL
{
	public partial class TLContactsFound : TLObject 
	{
		...
		public TLContactsFound(TLBinaryReader from, TLType type = TLType.ContactsFound)
		{
			Read(from, type);
		}
		...
		public override void Read(TLBinaryReader from, TLType type = TLType.ContactsFound)
		{
