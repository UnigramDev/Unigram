...
namespace Telegram.Api.TL
{
	public partial class TLInputBotInlineMessageMediaAuto : TLInputBotInlineMessageBase, ITLMediaCaption 
	{
		...
		public TLInputBotInlineMessageMediaAuto(TLBinaryReader from, TLType type = TLType.InputBotInlineMessageMediaAuto)
		{
			Read(from, type);
		}
		...
		public override void Read(TLBinaryReader from, TLType type = TLType.InputBotInlineMessageMediaAuto)
		{
