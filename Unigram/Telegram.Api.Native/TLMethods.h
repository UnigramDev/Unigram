...
#define MakeTLMethodTraits(objectTypeName, constructor, isLayerNeeded) MakeTLObjectTraits(objectTypeName, constructor, isLayerNeeded, "Telegram.Api.Native.TL.Methods")
