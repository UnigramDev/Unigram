 ...
 * Translated to C# by FrayxRulez on 20.04.17.
 */
...
namespace Unigram.Core
{
    public class EncryptionKeyEmojifier
    {
        ...
        public static String[] Emojify(byte[] sha256)
        {
            if (sha256.Length != 32)
            {
                throw new ArgumentException("sha256 needs to be exactly 32 bytes", nameof(sha256));
            }
