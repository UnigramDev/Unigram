	...
	namespace Native 
	{
		namespace Tasks
		{
			...
			public:
				...
				static void UpdateToast(String^ caption, String^ message, String^ attribution, String^ session, String^ sound, String^ launch, String^ tag, String^ group, String^ picture, String^ date, String^ loc_key); 
