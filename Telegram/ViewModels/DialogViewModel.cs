    ...
    public partial class DialogViewModel : ComposeViewModel, IDelegable<IDialogDelegate>
    {
        ...
        protected async Task AddHeaderAsync(IList<Message> messages, Message previous)
        {
            ...
            if (fullInfo != null && fullInfo.BotInfo?.Description.Length > 0)
            {
                ...
                messages.Add(new Message(0, new MessageSenderUser(user.Id), chat.Id, null, null, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, 0, 0, null, null, null, null, null, null, 0, 0, null, 0, 0, 0, 0, 0, string.Empty, 0, 0, string.Empty, content, null));
                return;
            }
        ...
        AddDate:
            if (_topic == null && _thread != null)
            {
                ...
                if (empty)
                {
                    messages.Add(new Message(0, previous.SenderId, previous.ChatId, null, null, previous.IsOutgoing, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, previous.IsChannelPost, previous.IsTopicMessage, false, previous.Date, 0, null, null, null, null, null, null, 0, 0, null, 0, 0, 0, 0, 0, string.Empty, 0, 0, string.Empty, new MessageCustomServiceAction(Strings.NoComments), null));
                }
                else
                {
