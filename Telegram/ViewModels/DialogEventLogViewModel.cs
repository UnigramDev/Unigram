...
namespace Telegram.ViewModels
{
    public class DialogEventLogViewModel : DialogViewModel
    {
        ...
        private Message CreateMessage(long chatId, bool isChannel, ChatEvent chatEvent, bool child = false)
        {
            ...
            return new Message(chatEvent.Id, sender, chatId, null, null, false, false, false, false, false, isChannel, false, false, chatEvent.Date, 0, null, null, null, null, null, null, 0, 0, null, 0, 0, 0, 0, 0, string.Empty, 0, 0, string.Empty, null, null);
        }
