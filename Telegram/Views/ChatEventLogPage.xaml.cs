...
{
    public sealed partial class ChatEventLogPage : HostedPage, IChatPage
    {
        ...
        {
            var viewModel = navigationService.Session.Resolve<DialogEventLogViewModel, IDialogDelegate>(View);
