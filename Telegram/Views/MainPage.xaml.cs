...
namespace Telegram.Views
{
    public sealed partial class MainPage : Page, IRootContentPage, INavigatingPage, IChatListDelegate
    {
        ...
        private void ArchivedChats_ContextRequested(UIElement sender, ContextRequestedEventArgs args)
        {
            ...
            flyout.CreateFlyoutItem(ToggleArchive, Strings.ArchiveMoveToMainMenu, Icons.Collapse);
        ...
        private async void Chat_ContextRequested(UIElement sender, ContextRequestedEventArgs args)
        {
            ...
            flyout.CreateFlyoutItem(DialogArchive_Loaded, viewModel.ArchiveChat, chat, chat.Positions.Any(x => x.List is ChatListArchive) ? Strings.Unarchive : Strings.Archive, Icons.Archive);
