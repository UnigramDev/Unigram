...
{
    public sealed partial class ChatWelcomeMessagesPage : HostedPage, IChatPage
    {
        public DialogViewModel ViewModel => DataContext as DialogViewModel;

        public ChatWelcomeMessagesPage()
        {
            InitializeComponent();
        ...
        {
            var viewModel = navigationService.Session.Resolve<DialogWelcomeMessagesViewModel, IDialogDelegate>(View);
