...
{
    public sealed partial class SettingsPrivacyShowProfileAudioPage : HostedPage
    {
        public SettingsPrivacyShowProfileAudioViewModel ViewModel => DataContext as SettingsPrivacyShowProfileAudioViewModel;

        public SettingsPrivacyShowProfileAudioPage()
        {
            InitializeComponent();
            Title = Strings.PrivacyMusic;
        }
