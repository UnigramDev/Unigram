...
namespace Telegram.Controls.Messages
{
    ...
    public sealed partial class MessageBubble : ControlEx, IReactionsDelegate
    {
        ...
        public void UpdateMockup(IClientService clientService, Chat chat, MessageSender sender, string tag, ChatMemberRank rank)
        {
            ...
            if (sender != null)
            {
                var message = new Message(chat.Id, sender, null, 0, null, null, false, false, false, false, false, false, false, false, false, false, 0, 0, null, null, null, Array.Empty<UnreadReaction>(), null, null, null, null, null, 0, 0, 0, null, 0, 0, string.Empty, 0, string.Empty, 0, 0, null, string.Empty, null, null, null);
