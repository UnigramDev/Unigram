...
namespace Telegram.Controls.Views
{
    public sealed partial class InteractionsView : UserControl, IIncrementalCollectionOwner
    {
        ...
        private void ShowSkeleton()
        {
            ...
            var lookup = ThemeService.GetLookup(ActualTheme == Microsoft.UI.Xaml.ElementTheme.Dark ? Services.Settings.TelegramTheme.Dark : Services.Settings.TelegramTheme.Light);
