        ...
        public void UpdateMessageReactions(IClientService clientService, IList<PaidReactor> reactors, PaidReactor self)
        {
            ...
            if (reactors?.Count > 0)
            {
                ...
                else
                {
                    ...
                    var diff = DiffCalculator.Create(prev, reactors, this);
                    ...
                    while (diff.Next())
                    {
                        ...
                        {
                            UpdateItem(diff.OldValue, diff.NewValue, diff.NewSeqIndex);
                        }
                    }
                }
