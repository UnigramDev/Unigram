...
namespace Telegram.Controls.Cells
{
    ...
    public partial class GraphicsCaptureItemVisual
    {
        ...
        private GraphicsCaptureItemVisual(GraphicsCaptureItem item, CanvasDevice device)
        {
            ...
            _surface = compositionGraphicsDevice.CreateDrawingSurface(new Size(0, 0), Microsoft.Graphics.DirectX.DirectXPixelFormat.B8G8R8A8UIntNormalized, Microsoft.Graphics.DirectX.DirectXAlphaMode.Premultiplied);
