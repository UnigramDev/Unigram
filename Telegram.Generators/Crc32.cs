...
{
    /// <summary>
    /// The generated parsers dispatch on the CRC32 of a field or type name, so the generator has to
    /// produce exactly the values ClientJson computes at runtime. This is a verbatim copy of that
    /// implementation - the two must not drift.
    /// </summary>
    internal static class Crc32
    {
        public static uint Compute(string value)
        {
            return ComputeCrc32(Encoding.UTF8.GetBytes(value));
        }
